...
samtools view -h -s 0.4 ${old_path}/tophat_output/picard_output/sorted.bam NC_000080.6 NC_000072.6 > ${new_path}/sorted.bam
samtools view -h -s 0.4 ${old_path}/tophat_output/unmapped.bam > ${new_path}/unmapped.bam
...
python /home/eecs/gunjan_baid/trapes/pythonScripts/grid_search.py /home/eecs/gunjan_baid/trapes/${OUT_DIR}/ ${CELL_DIR}
