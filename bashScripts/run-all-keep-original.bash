...
do
        ...
        python pythonScripts/helper.py ${new_path}/sorted.bam ${new_path}/output.sorted.bam
        python pythonScripts/helper.py ${new_path}/unmapped.bam ${new_path}/output.unmapped.bam
	bowtie2 -q --phred33 -x Data/mm10_ncbi/index/mm10 -U ${new_path}/output.sorted.fq -S ${new_path}/temp1.sam
        ...
        rm ${new_path}/output.sorted.bam ${new_path}/temp1.sam ${new_path}/temp2.sam ${new_path}/temp3.sam ${new_path}/temp4.sam
        samtools view -h -b -F 4 ${new_path}/all.bam | samtools sort > ${new_path}/output.sorted.bam
        samtools index ${new_path}/output.sorted.bam
...
python /home/eecs/gunjan_baid/trapes/${OUT_DIR}/trapes.py -path /home/eecs/gunjan_baid/trapes/${OUT_DIR}/cells/ -bam sorted.bam -unmapped unmapped.bam -output output -sumF /home/eecs/gunjan_baid/trapes/${OUT_DIR}/summary -genome mm10_ncbi -trim 50 -lowQ
